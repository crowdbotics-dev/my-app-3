"""
Django settings for my_app_3 project.
...
WSGI_APPLICATION = 'my_app_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "my_app_3 API",
    "DESCRIPTION": "API documentation for my_app_3 App",
    "VERSION": "v1",
}
